...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
    ...
    return (
        <div className="w-full bg-white dark:bg-black font-sans md:px-10 pt-40" ref={containerRef}>
            ...
            <div className="text-center animate-fade-in">
                ...
                A timeline of my professional journey that forged me
                </p>
            </div>
                    ...
                    <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-10">
                        <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <h3 className="hidden md:block text-xl md:pl-20 md:text-base font-bold text-neutral-500 dark:text-neutral-500 ">
                                    {item.date}
                                </h3>
                            </div>
                        </div>
